...
$stime = gmdate('Y-m-d H:i:s', time() + 3600 * 8);
...
<div id="page">
    <div id="header">
        <h1><a href="http://rsis.me">RS</a></h1>
        <div id="download">RS</div>
    </div>
...
<div id="footer">
&copy; <?php echo date("Y",time());?> <a href="http://rsis.me">RS</a> PHP探针 <?php echo $version; ?> All Rights Reserved.<br />
